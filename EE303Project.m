%Prepared by Muhammet AKGÜL and Salih Emre KAYNAR for EE 303 Fundamentals
%of Power Systems Course Final Project , Özyeðin University.
function varargout = EE303Project(varargin)
% EE303Project MATLAB code for EE303Project.fig
%      EE303Project, by itself, creates a new EE303Project or raises the existing
%      singleton*.
%
%      H = EE303Project returns the handle to a new EE303Project or the handle to
%      the existing singleton*.
%
%      EE303Project('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EE303Project.M with the given input arguments.
%
%      EE303Project('Property','Value',...) creates a new EE303Project or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before EE303Project_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to EE303Project_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help EE303Project

% Last Modified by GUIDE v2.5 25-Dec-2018 14:40:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EE303Project_OpeningFcn, ...
                   'gui_OutputFcn',  @EE303Project_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before EE303Project is made visible.
function EE303Project_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EE303Project (see VARARGIN)

% Choose default command line output for EE303Project
...
% UIWAIT makes EE303Project wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = EE303Project_OutputFcn(hObject, eventdata, handles) 
